...
// t('plugin__policy-console-plugin~ClusterPolicyReport')
// t('plugin__policy-console-plugin~No PolicyReport found')

export function useTranslation() {
    return useReactI18NextTranslation('plugin__policy-console-plugin');
}
